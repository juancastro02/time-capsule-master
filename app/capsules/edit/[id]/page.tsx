...
export default function EditCapsulePage() {
  ...
  const [originalCapsule, setOriginalCapsule] = useState<TimeCapsule | null>(
    null
  );
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.success("Success!", {
        ...
        action: {
          label: "View Pending",
          onClick: () => router.push("/capsules/pending"),
        },
        duration: 5000,
      });
      ...
      toast.error("Error", {
        description:
          "There was an error updating your time capsule. Please try again.",
      });
    } finally {
      setIsSubmitting(false);
    }
      ...
      <div className="flex items-center justify-center min-h-[70vh]">
        <div className="text-center px-4 sm:px-0 w-full max-w-md space-y-4">
          ...
          <p className="mb-6 text-muted-foreground">
            The time capsule you're trying to edit doesn't exist.
          </p>
              ...
              <div className="mt-8">
                ...
                >
                  ...
                  <TabsContent value="message" className="space-y-2 pt-2">
                    <Label htmlFor="message" className="text-center block">
                      Your Message
                    </Label>
                    <Textarea
                      id="message"
                  ...
                  <TabsContent value="image" className="space-y-2 pt-2">
                    <Label htmlFor="image-url" className="text-center block">
                      Image URL
                    </Label>
                    <Input
                      id="image-url"
